...
mov -28(%ebp), %eax	# Move var1_arr,R5
mov %eax, -20(%ebp)
...
mov -20(%ebp), %eax	# MoveArray R3,R5[R4]
mov -16(%ebp), %ebx
mov -12(%ebp), %ecx
mov %ecx, (%eax,%ebx,4)
...
mov -28(%ebp), %eax	# Move var1_arr,R2
mov %eax, -8(%ebp)
...
mov $14, %eax	# Move 14,R3
mov %eax, -12(%ebp)

mov $3, %eax	# Move 3,R4
mov %eax, -16(%ebp)

# StaticCall _DV_Arrays_buildArr(param1_size=R3, param2_val=R4),R3
mov -16(%ebp), %eax
push %eax
mov -12(%ebp), %eax
push %eax
...
# StaticCall _DV_Arrays_sumArr(param1_a=R2, param2_b=R3),R2
mov -12(%ebp), %eax
push %eax
mov -8(%ebp), %eax
push %eax
