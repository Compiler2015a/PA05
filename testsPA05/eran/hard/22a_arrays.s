...
mov -28(%ebp), %eax	# Move var1_arr,R3
mov %eax, -12(%ebp)
...
mov -12(%ebp), %eax	# MoveArray R3,R3[R4]
mov -16(%ebp), %ebx
mov -12(%ebp), %ecx
mov %ecx, (%eax,%ebx,4)

mov -12(%ebp), %eax	# MoveArray R3[R4],R2
mov -16(%ebp), %ebx
mov (%eax,%ebx,4), %ecx
mov %ecx, -8(%ebp)
...
mov -16(%ebp), %eax	# MoveArray R4,R4[R5]
mov -20(%ebp), %ebx
mov -16(%ebp), %ecx
mov %ecx, (%eax,%ebx,4)

mov -16(%ebp), %eax	# MoveArray R4[R5],R3
mov -20(%ebp), %ebx
mov (%eax,%ebx,4), %ecx
mov %ecx, -12(%ebp)
...
mov 8(%ebp), %eax	# Move param1_a,R6
mov %eax, -24(%ebp)
...
mov -24(%ebp), %eax	# MoveArray R6[R7],R5
mov -28(%ebp), %ebx
mov (%eax,%ebx,4), %ecx
mov %ecx, -20(%ebp)

mov 12(%ebp), %eax	# Move param2_b,R7
mov %eax, -28(%ebp)
...
mov -28(%ebp), %eax	# ArrayLength R7,R10
mov -4(%eax), %eax
mov $4, %ebx
mov $0, %edx
div %ebx
...
mov -28(%ebp), %eax	# MoveArray R7[R8],R6
mov -32(%ebp), %ebx
mov (%eax,%ebx,4), %ecx
mov %ecx, -24(%ebp)
...
mov -52(%ebp), %eax	# Move var2_sum,R5
mov %eax, -20(%ebp)
...
mov -20(%ebp), %eax	# MoveArray R5,R5[R6]
mov -24(%ebp), %ebx
mov -20(%ebp), %ecx
mov %ecx, (%eax,%ebx,4)

mov -20(%ebp), %eax	# MoveArray R5[R6],R4
mov -24(%ebp), %ebx
mov (%eax,%ebx,4), %ecx
mov %ecx, -16(%ebp)
